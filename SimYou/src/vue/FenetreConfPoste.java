...
public class FenetreConfPoste extends JDialog implements ActionListener {

	private final JPanel contentPanel = new JPanel();
	

	private JTextField FrequencePostage;
	...
	public JTextField getFrequencePostage() {
		return FrequencePostage;
	}

	public void setFrequencePostage(JTextField frequencePostage) {
		FrequencePostage = frequencePostage;
	}
