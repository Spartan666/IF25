...
public class ComportementPosteur extends Comportement {
	...
	public void poster(Utilisateur utilisateur) {
		...
		int ageRequis = 3 + new Random().nextInt(15); //Age requis entre 3 et 18 ans
		Video video = new Video("video" + chaine.getVideos().size() + utilisateur.getPrenom() + utilisateur.getNom(), "Blabla", duree, null, chaine, ageRequis); //Création de la video
